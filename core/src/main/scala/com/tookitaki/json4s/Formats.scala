...
import com.tookitaki.json4s.prefs.EmptyValueStrategy
 ...
 */
@implicitNotFound(
  "No com.tookitaki.json4s.Formats found. Try to bring an instance of com.tookitaki.json4s.Formats in scope or use the com.tookitaki.json4s.DefaultFormats."
)

...
import com.tookitaki.json4s.native.JsonMethods._
```
...
```scala
import com.tookitaki.json4s._
import com.tookitaki.json4s.jackson.JsonMethods._
```
...
com.tookitaki.json4s.jackson.JsonMethods.mapper.configure(SerializationFeature.CLOSE_CLOSEABLE, false)
```
...
https://search.maven.org/search?q=com.tookitaki.json4s
...
```scala
val json4sNative = "com.tookitaki.json4s" %% "json4s-native" % "{latestVersion}"
```

For the Jackson support add the following dependency to your project description:

```scala
val json4sJackson = "com.tookitaki.json4s" %% "json4s-jackson" % "{latestVersion}"
```
...
```xml
<dependency>
  <groupId>com.tookitaki.json4s</groupId>
...
```scala
scala> import com.tookitaki.json4s._
scala> import com.tookitaki.json4s.native.JsonMethods._

scala> parse(""" { "numbers" : [1, 2, 3, 4] } """)
res0: com.tookitaki.json4s.JValue =
      JObject(List((numbers,JArray(List(JInt(1), JInt(2), JInt(3), JInt(4))))))

scala> parse("""{"name":"Toy","price":35.35}""", useBigDecimalForDouble = true)
res1: com.tookitaki.json4s.JValue =
...
```scala
scala> import com.tookitaki.json4s._
scala> import com.tookitaki.json4s.jackson.JsonMethods._
...
// or
import com.tookitaki.json4s.JsonDSL.WithDouble._
```

For the big decimal mode dsl use:

```scala
import com.tookitaki.json4s.JsonDSL.WithBigDecimal._
```
...
changed: com.tookitaki.json4s.JValue = JNothing
added: com.tookitaki.json4s.JValue = JNothing
deleted: com.tookitaki.json4s.JValue = JObject(List((lotto,JObject(List(JField(winners,
...
```scala
scala> import com.tookitaki.json4s.jackson.JsonMethods._
scala> import com.tookitaki.json4s.JsonDSL._
...
scala> json \\ "spouse"
res0: com.tookitaki.json4s.JValue = JObject(List(
...
res6: Option[com.tookitaki.json4s.JValue] = Some((name,JString(Joe)))

scala> json filterField {
         case JField("name", _) => true
         case _ => false
       }
res7: List[com.tookitaki.json4s.JField] = List(JField(name,JString(Joe)), JField(name,JString(Marilyn)))

scala> json transformField {
         case JField("name", JString(s)) => ("NAME", JString(s.toUpperCase))
       }
res8: com.tookitaki.json4s.JValue = JObject(List((person,JObject(List(
...
res0: com.tookitaki.json4s.JValue = JObject(List((name,JString(Mary)), (age,JInt(5))))

scala> (json \ "children")(1) \ "name"
res1: com.tookitaki.json4s.JValue = JString(Mazy)

scala> json \\ classOf[JInt]
res2: List[com.tookitaki.json4s.JInt#Values] = List(5, 3)

scala> json \ "children" \\ classOf[JString]
res3: List[com.tookitaki.json4s.JString#Values] = List(Mary, Mazy)
```
...
```scala
scala> import com.tookitaki.json4s._
scala> import com.tookitaki.json4s.native.Serialization
scala> import com.tookitaki.json4s.native.Serialization.{read, write}
...
```scala
scala> import com.tookitaki.json4s._
scala> import com.tookitaki.json4s.jackson.Serialization
scala> import com.tookitaki.json4s.jackson.Serialization.{read, write}
...
```scala
// Scala enums
implicit val formats: Formats = com.tookitaki.json4s.DefaultFormats + new com.tookitaki.json4s.ext.EnumSerializer(MyEnum)
// or
implicit val formats: Formats = com.tookitaki.json4s.DefaultFormats + new com.tookitaki.json4s.ext.EnumNameSerializer(MyEnum)

// Joda Time
implicit val formats: Formats = com.tookitaki.json4s.DefaultFormats ++ com.tookitaki.json4s.ext.JodaTimeSerializers.all

// Java 8 Date & Time
implicit val formats: Formats = com.tookitaki.json4s.DefaultFormats ++ com.tookitaki.json4s.ext.JavaTimeSerializers.all
```
...
```scala
scala> import com.tookitaki.json4s.Xml.{toJson, toXml}
scala> val xml =
         <users>
           <user>
             <id>1</id>

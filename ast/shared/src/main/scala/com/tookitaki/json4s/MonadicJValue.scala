...
import com.tookitaki.json4s.JsonAST.JField
...
class MonadicJValue(private val jv: JValue) extends AnyVal {
  ...
  /**
   * Camelize all the keys in this com.tookitaki.json4s.JValue
   */
  def camelizeKeys: JValue = rewriteJsonAST(this.camelize)

  /**
   * Pascalize all the keys in this com.tookitaki.json4s.JValue
   */
  def pascalizeKeys: JValue = rewriteJsonAST(this.pascalize)

  /**
   * Underscore all the keys in this com.tookitaki.json4s.JValue
   */
  def snakizeKeys: JValue = rewriteJsonAST(this.underscore)

  /**
   * Underscore the camel cased only keys in this [[com.tookitaki.json4s.JValue]]
   */
  ...
  /**
   * Remove the com.tookitaki.json4s.JNothing and com.tookitaki.json4s.JNull from
   * a com.tookitaki.json4s.JArray or com.tookitaki.json4s.JObject
   */
  def noNulls = remove {

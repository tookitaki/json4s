...
sealed abstract class JValue extends Diff.Diffable with Product with Serializable {
  ...
  /**
   * When this [[com.tookitaki.json4s.JValue]] is a [[com.tookitaki.json4s.JNothing]] or a [[com.tookitaki.json4s.JNull]], this method returns [[scala.None]]
  ...
  /**
   * When this [[com.tookitaki.json4s.JValue]] is a [[com.tookitaki.json4s.JNothing]], this method returns [[scala.None]]
   * When it has a value it will return [[scala.Some]]
   */

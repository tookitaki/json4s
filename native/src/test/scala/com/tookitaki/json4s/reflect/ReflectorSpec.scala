package com.tookitaki.json4s.reflect

import com.tookitaki.json4s.DateTime

import java.sql.Timestamp
import java.util.Date
import com.tookitaki.json4s.{DateTime, DefaultFormats, Formats, JInt, JObject, JString, MappingException, Obj, Objs, reflect}
...
class ReflectorSpec extends AnyWordSpec {
  ...
  "Reflector" should {
    ...
    "issue 507" in {
      val result = com.tookitaki.json4s.Extraction.decompose(

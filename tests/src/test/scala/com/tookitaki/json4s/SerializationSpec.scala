  ...
  "Serialization of case class with many Option[T] fields" should {
    ...
    "produce valid JSON with preserved empty fields" should {
      ...
      "#270 Issue serialising sequences of AnyVal" in {
        ...
        /*
        [error] Caused by com.tookitaki.json4s.package$MappingException: Do not know how to convert JObject(List((id,JString(alice)))) into class java.lang.String
        [error] com.tookitaki.json4s.reflect.package$.fail(package.scala:93)
        [error] com.tookitaki.json4s.Extraction$.convert(Extraction.scala:676)
        [error] com.tookitaki.json4s.Extraction$.extract(Extraction.scala:388)
         */
      }
...
//      }
      ...
      "#674 serializes a boolean in a map from a trait in Scala 2.13" in {
        ...
        val json = com.tookitaki.json4s.native.Serialization.writePretty(expected)
